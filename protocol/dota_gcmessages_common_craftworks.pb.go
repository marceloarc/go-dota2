...
const file_dota_gcmessages_common_craftworks_proto_rawDesc = "" +
	"\n" +
	"'dota_gcmessages_common_craftworks.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17dota_shared_enums.proto\x1a\x16gcsdk_gcmessages.proto\"\xce\x01\n" +
	"\x18CMsgCraftworksComponents\x12n\n" +
	"\x14component_quantities\x18\x01 \x03(\v2;.protocol.CMsgCraftworksComponents.ComponentQuantitiesEntryR\x13componentQuantities\x1aB\n" +
	"\x18ComponentQuantitiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\rR\x05value\"\xa6\x01\n" +
	"\x19CMsgCraftworksQuestReward\x12\x19\n" +
	"\bquest_id\x18\x01 \x01(\rR\aquestId\x12O\n" +
	"\x11reward_components\x18\x02 \x01(\v2\".protocol.CMsgCraftworksComponentsR\x10rewardComponents\x12\x1d\n" +
	"\n" +
