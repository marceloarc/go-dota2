...
type CMsgSetTalentContentResponse struct {
	state         protoimpl.MessageState                `protogen:"open.v1"`
	Result        *CMsgSetTalentContentResponse_EResult `protobuf:"varint,1,opt,name=result,enum=protocol.CMsgSetTalentContentResponse_EResult,def=0" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_dota_gcmessages_webapi_proto_goTypes = []any{
	...
	(ETalentContentStatus)(0),                                      // 3: protocol.ETalentContentStatus
	(ETalentContentAssetType)(0),                                   // 4: protocol.ETalentContentAssetType
	(ETalentContentAssetStatus)(0),                                 // 5: protocol.ETalentContentAssetStatus
