...
type CMsgReadyUpStatus struct {
	...
	LocalReadyState *DOTALobbyReadyState   `protobuf:"varint,6,opt,name=local_ready_state,json=localReadyState,enum=protocol.DOTALobbyReadyState,def=0" json:"local_ready_state,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_dota_gcmessages_client_match_management_proto_rawDesc = "" +
	...
	"readyUpKey\x12I\n" +
	"\x0ehardware_specs\x18\x03 \x01(\v2\".protocol.CDOTAClientHardwareSpecsR\rhardwareSpecs\"\xb5\x02\n" +
	...
	"\x10declined_indices\x18\x05 \x03(\rR\x0fdeclinedIndices\x12i\n" +
	"\x11local_ready_state\x18\x06 \x01(\x0e2\x1d.protocol.DOTALobbyReadyState:\x1eDOTALobbyReadyState_UNDECLAREDR\x0flocalReadyState\"\x18\n" +
	"\x16CMsgAbandonCurrentGame\"E\n" +
	"\x15CMsgLobbyScenarioSave\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x05R\aversion\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\"\xc2\x12\n" +
	...
	"\x12requested_hero_ids\x182 \x03(\x05R\x10requestedHeroIds\x12D\n" +
	...
	"\x13shuffle_draft_order\x18\x01 \x01(\bR\x11shuffleDraftOrder\"\xc6\x01\n" +
	...
	"\rlobby_details\x18\a \x01(\v2%.protocol.CMsgPracticeLobbySetDetailsR\flobbyDetails\"\xd2\x01\n" +
...
var file_dota_gcmessages_client_match_management_proto_goTypes = []any{
	...
	(*CMsgPracticeLobbyListResponseEntry_CLobbyMember)(nil),         // 59: protocol.CMsgPracticeLobbyListResponseEntry.CLobbyMember
	(*CMsgQuickJoinCustomLobby_LegacyRegionPing)(nil),               // 60: protocol.CMsgQuickJoinCustomLobby.LegacyRegionPing
	(*CMsgSpectatorLobbyGameDetails_Team)(nil),                      // 61: protocol.CMsgSpectatorLobbyGameDetails.Team
	(*CMsgSpectatorLobbyListResponse_SpectatorLobby)(nil),           // 62: protocol.CMsgSpectatorLobbyListResponse.SpectatorLobby
	(MatchType)(0),                   // 63: protocol.MatchType
	(MatchLanguages)(0),              // 64: protocol.MatchLanguages
	(*CMsgClientPingData)(nil),       // 65: protocol.CMsgClientPingData
	(DOTALobbyReadyState)(0),         // 66: protocol.DOTALobbyReadyState
	(*CDOTAClientHardwareSpecs)(nil), // 67: protocol.CDOTAClientHardwareSpecs
	(*CLobbyTeamDetails)(nil),        // 68: protocol.CLobbyTeamDetails
	(DOTA_CM_PICK)(0),                // 69: protocol.DOTA_CM_PICK
	(DOTABotDifficulty)(0),           // 70: protocol.DOTABotDifficulty
	(LobbyDotaTVDelay)(0),            // 71: protocol.LobbyDotaTVDelay
	(DOTALobbyVisibility)(0),         // 72: protocol.DOTALobbyVisibility
	(LobbyDotaPauseSetting)(0),       // 73: protocol.LobbyDotaPauseSetting
	(DOTASelectionPriorityRules)(0),  // 74: protocol.DOTASelectionPriorityRules
	(DOTA_GC_TEAM)(0),                // 75: protocol.DOTA_GC_TEAM
	(DOTA_GameMode)(0),               // 76: protocol.DOTA_GameMode
	(DOTAJoinLobbyResult)(0),         // 77: protocol.DOTAJoinLobbyResult
	(EDOTAGroupMergeResult)(0),       // 78: protocol.EDOTAGroupMergeResult
}
var file_dota_gcmessages_client_match_management_proto_depIdxs = []int32{
	63, // 0: protocol.CMsgStartFindingMatch.match_type:type_name -> protocol.MatchType
	64, // 1: protocol.CMsgStartFindingMatch.game_language_enum:type_name -> protocol.MatchLanguages
	65, // 2: protocol.CMsgStartFindingMatch.ping_data:type_name -> protocol.CMsgClientPingData
	0,  // 3: protocol.CMsgStartFindingMatchResult.result:type_name -> protocol.EStartFindingMatchResult
	63, // 4: protocol.CMsgPartyBuilderOptions.match_type:type_name -> protocol.MatchType
	64, // 5: protocol.CMsgPartyBuilderOptions.language:type_name -> protocol.MatchLanguages
	66, // 6: protocol.CMsgReadyUp.state:type_name -> protocol.DOTALobbyReadyState
	67, // 7: protocol.CMsgReadyUp.hardware_specs:type_name -> protocol.CDOTAClientHardwareSpecs
	66, // 8: protocol.CMsgReadyUpStatus.local_ready_state:type_name -> protocol.DOTALobbyReadyState
	68, // 9: protocol.CMsgPracticeLobbySetDetails.team_details:type_name -> protocol.CLobbyTeamDetails
	69, // 10: protocol.CMsgPracticeLobbySetDetails.cm_pick:type_name -> protocol.DOTA_CM_PICK
	70, // 11: protocol.CMsgPracticeLobbySetDetails.bot_difficulty_radiant:type_name -> protocol.DOTABotDifficulty
	71, // 12: protocol.CMsgPracticeLobbySetDetails.dota_tv_delay:type_name -> protocol.LobbyDotaTVDelay
	72, // 13: protocol.CMsgPracticeLobbySetDetails.visibility:type_name -> protocol.DOTALobbyVisibility
	73, // 14: protocol.CMsgPracticeLobbySetDetails.pause_setting:type_name -> protocol.LobbyDotaPauseSetting
	70, // 15: protocol.CMsgPracticeLobbySetDetails.bot_difficulty_dire:type_name -> protocol.DOTABotDifficulty
	74, // 16: protocol.CMsgPracticeLobbySetDetails.selection_priority_rules:type_name -> protocol.DOTASelectionPriorityRules
	8,  // 17: protocol.CMsgPracticeLobbySetDetails.scenario_save:type_name -> protocol.CMsgLobbyScenarioSave
	58, // 18: protocol.CMsgPracticeLobbySetDetails.ability_draft_specific_details:type_name -> protocol.CMsgPracticeLobbySetDetails.AbilityDraftSpecificDetails
	9,  // 19: protocol.CMsgPracticeLobbyCreate.lobby_details:type_name -> protocol.CMsgPracticeLobbySetDetails
	75, // 20: protocol.CMsgPracticeLobbySetTeamSlot.team:type_name -> protocol.DOTA_GC_TEAM
	70, // 21: protocol.CMsgPracticeLobbySetTeamSlot.bot_difficulty:type_name -> protocol.DOTABotDifficulty
	75, // 22: protocol.CMsgPracticeLobbySetCoach.team:type_name -> protocol.DOTA_GC_TEAM
	76, // 23: protocol.CMsgPracticeLobbyList.game_mode:type_name -> protocol.DOTA_GameMode
	59, // 24: protocol.CMsgPracticeLobbyListResponseEntry.members:type_name -> protocol.CMsgPracticeLobbyListResponseEntry.CLobbyMember
	76, // 25: protocol.CMsgPracticeLobbyListResponseEntry.game_mode:type_name -> protocol.DOTA_GameMode
	22, // 26: protocol.CMsgPracticeLobbyListResponse.lobbies:type_name -> protocol.CMsgPracticeLobbyListResponseEntry
	76, // 27: protocol.CMsgLobbyList.game_mode:type_name -> protocol.DOTA_GameMode
	22, // 28: protocol.CMsgLobbyListResponse.lobbies:type_name -> protocol.CMsgPracticeLobbyListResponseEntry
	77, // 29: protocol.CMsgPracticeLobbyJoinResponse.result:type_name -> protocol.DOTAJoinLobbyResult
	...
	60, // 34: protocol.CMsgQuickJoinCustomLobby.legacy_region_pings:type_name -> protocol.CMsgQuickJoinCustomLobby.LegacyRegionPing
	65, // 35: protocol.CMsgQuickJoinCustomLobby.ping_data:type_name -> protocol.CMsgClientPingData
	77, // 36: protocol.CMsgQuickJoinCustomLobbyResponse.result:type_name -> protocol.DOTAJoinLobbyResult
	70, // 37: protocol.CMsgBotGameCreate.difficulty_radiant:type_name -> protocol.DOTABotDifficulty
	75, // 38: protocol.CMsgBotGameCreate.team:type_name -> protocol.DOTA_GC_TEAM
	70, // 39: protocol.CMsgBotGameCreate.difficulty_dire:type_name -> protocol.DOTABotDifficulty
	78, // 40: protocol.CMsgDOTAGroupMergeReply.result:type_name -> protocol.EDOTAGroupMergeResult
	61, // 41: protocol.CMsgSpectatorLobbyGameDetails.radiant_team:type_name -> protocol.CMsgSpectatorLobbyGameDetails.Team
	61, // 42: protocol.CMsgSpectatorLobbyGameDetails.dire_team:type_name -> protocol.CMsgSpectatorLobbyGameDetails.Team
	...
	62, // 45: protocol.CMsgSpectatorLobbyListResponse.lobbies:type_name -> protocol.CMsgSpectatorLobbyListResponse.SpectatorLobby
