...
const file_dota_gcmessages_common_overworld_proto_rawDesc = "" +
	"\n" +
	"&dota_gcmessages_common_overworld.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17dota_shared_enums.proto\x1a\x1cdota_gcmessages_common.proto\x1a&dota_gcmessages_common_survivors.proto\x1a\x16gcsdk_gcmessages.proto\"U\n" +
	"\x17CMsgOverworldTokenCount\x12\x19\n" +
	"\btoken_id\x18\x01 \x01(\rR\atokenId\x12\x1f\n" +
	"\vtoken_count\x18\x02 \x01(\rR\n" +
	"tokenCount\"b\n" +
	"\x1aCMsgOverworldTokenQuantity\x12D\n" +
	"\ftoken_counts\x18\x01 \x03(\v2!.protocol.CMsgOverworldTokenCountR\vtokenCounts\"\xd0\x02\n" +
	"'CMsgOverworldEncounterTokenTreasureData\x12e\n" +
	"\x0ereward_options\x18\x01 \x03(\v2>.protocol.CMsgOverworldEncounterTokenTreasureData.RewardOptionR\rrewardOptions\x1a\xbd\x01\n" +
	"\fRewardOption\x12\x1f\n" +
	"\vreward_data\x18\x01 \x01(\rR\n" +
	"rewardData\x12C\n" +
	"\n" +
	"token_cost\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\ttokenCost\x12G\n" +
	"\ftoken_reward\x18\x03 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\vtokenReward\"\xad\x02\n" +
	"$CMsgOverworldEncounterTokenQuestData\x12L\n" +
	"\x06quests\x18\x01 \x03(\v24.protocol.CMsgOverworldEncounterTokenQuestData.QuestR\x06quests\x1a\xb6\x01\n" +
	"\x05Quest\x12\x1f\n" +
	"\vreward_data\x18\x01 \x01(\rR\n" +
	"rewardData\x12C\n" +
	"\n" +
	"token_cost\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\ttokenCost\x12G\n" +
	"\ftoken_reward\x18\x03 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\vtokenReward\"2\n" +
	"\x15CMsgOverworldHeroList\x12\x19\n" +
	"\bhero_ids\x18\x01 \x03(\x05R\aheroIds\"\x80\x01\n" +
	"$CMsgOverworldEncounterChooseHeroData\x12<\n" +
	"\thero_list\x18\x01 \x01(\v2\x1f.protocol.CMsgOverworldHeroListR\bheroList\x12\x1a\n" +
	...
	"\avisited\x18\x04 \x01(\bR\avisited\"h\n" +
	"\x1aCMsgOverworldEncounterData\x12J\n" +
	"\x14extra_encounter_data\x18\x01 \x03(\v2\x18.protocol.CExtraMsgBlockR\x12extraEncounterData\"\xdf\x01\n" +
	"\x11CMsgOverworldNode\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\rR\x06nodeId\x12[\n" +
	"\n" +
	"node_state\x18\x02 \x01(\x0e2\x1d.protocol.EOverworldNodeState:\x1dk_eOverworldNodeState_InvalidR\tnodeState\x12T\n" +
	"\x13node_encounter_data\x18\x03 \x01(\v2$.protocol.CMsgOverworldEncounterDataR\x11nodeEncounterData\"\xcc\x01\n" +
	"\x11CMsgOverworldPath\x12\x17\n" +
	"\apath_id\x18\x01 \x01(\rR\x06pathId\x12A\n" +
	"\tpath_cost\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\bpathCost\x12[\n" +
	"\n" +
	"path_state\x18\x03 \x01(\x0e2\x1d.protocol.EOverworldPathState:\x1dk_eOverworldPathState_InvalidR\tpathState\"|\n" +
	"\x1fCMsgOverworldMinigameCustomData\x12H\n" +
	"\x0esurvivors_data\x18\x01 \x01(\v2\x1f.protocol.CMsgSurvivorsUserDataH\x00R\rsurvivorsDataB\x0f\n" +
	"\rminigame_type\"\xad\x01\n" +
	...
	"\rminigame_data\x18\x05 \x03(\v21.protocol.CMsgOverworldUserData.MinigameDataEntryR\fminigameData\x1ad\n" +
	"\x11MinigameDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12=\n" +
	"\x05value\x18\x02 \x01(\v2'.protocol.CMsgOverworldMinigameUserDataR\x05value\"\xee\x01\n" +
	"\x19CMsgOverworldMatchRewards\x12D\n" +
	"\aplayers\x18\x01 \x03(\v2*.protocol.CMsgOverworldMatchRewards.PlayerR\aplayers\x1a\x8a\x01\n" +
	"\x06Player\x12\x1f\n" +
	"\vplayer_slot\x18\x01 \x01(\rR\n" +
	"playerSlot\x12<\n" +
	"\x06tokens\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\x06tokens\x12!\n" +
	"\foverworld_id\x18\x03 \x01(\rR\voverworldId\"G\n" +
	"\"CMsgClientToGCOverworldGetUserData\x12!\n" +
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\"\xd5\x02\n" +
	"*CMsgClientToGCOverworldGetUserDataResponse\x12l\n" +
	"\bresponse\x18\x01 \x01(\x0e2>.protocol.CMsgClientToGCOverworldGetUserDataResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12<\n" +
	"\tuser_data\x18\x02 \x01(\v2\x1f.protocol.CMsgOverworldUserDataR\buserData\"{\n" +
	"\tEResponse\x12\x14\n" +
	...
	"rewardData\x120\n" +
	"\x14periodic_resource_id\x18\x04 \x01(\rR\x12periodicResourceId\x12P\n" +
	...
	"-CMsgClientToGCOverworldVisitEncounterResponse\x12o\n" +
	"\bresponse\x18\x01 \x01(\x0e2A.protocol.CMsgClientToGCOverworldVisitEncounterResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xd2\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\rR\x06nodeId\"\xbd\x02\n" +
	")CMsgClientToGCOverworldMoveToNodeResponse\x12k\n" +
	"\bresponse\x18\x01 \x01(\x0e2=.protocol.CMsgClientToGCOverworldMoveToNodeResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xa2\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x13k_eInvalidOverworld\x10\x05\x12\x12\n" +
	"\x0ek_eInvalidNode\x10\x06\x12\x11\n" +
	"\rk_eNodeLocked\x10\a\"\x94\x02\n" +
	"\"CMsgClientToGCOverworldTradeTokens\x12!\n" +
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12E\n" +
	"\vtoken_offer\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\n" +
	"tokenOffer\x12I\n" +
	"\rtoken_request\x18\x03 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\ftokenRequest\x12\x16\n" +
	"\x06recipe\x18\x04 \x01(\rR\x06recipe\x12!\n" +
	"\fencounter_id\x18\x05 \x01(\rR\vencounterId\"\x88\x04\n" +
	"*CMsgClientToGCOverworldTradeTokensResponse\x12l\n" +
	"\bresponse\x18\x01 \x01(\x0e2>.protocol.CMsgClientToGCOverworldTradeTokensResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12M\n" +
	"\x0ftokens_received\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\x0etokensReceived\"\x9c\x02\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x1bk_eRewardDoesNotMatchRecipe\x10\f\"\xec\x01\n" +
	"!CMsgClientToGCOverworldGiftTokens\x12!\n" +
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12@\n" +
	"\n" +
	"token_gift\x18\x02 \x01(\v2!.protocol.CMsgOverworldTokenCountR\ttokenGift\x120\n" +
	"\x14recipient_account_id\x18\x03 \x01(\rR\x12recipientAccountId\x120\n" +
	"\x14periodic_resource_id\x18\x04 \x01(\rR\x12periodicResourceId\"\xa3\x03\n" +
	")CMsgClientToGCOverworldGiftTokensResponse\x12k\n" +
	"\bresponse\x18\x01 \x01(\x0e2=.protocol.CMsgClientToGCOverworldGiftTokensResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x88\x02\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\foverworld_id\x18\x02 \x01(\rR\voverworldId\"\xd9\x03\n" +
	":CMsgClientToGCOverworldRequestTokensNeededByFriendResponse\x12|\n" +
	"\bresponse\x18\x01 \x01(\x0e2N.protocol.CMsgClientToGCOverworldRequestTokensNeededByFriendResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12K\n" +
	"\x0etoken_quantity\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\rtokenQuantity\"\xcf\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\"\xab\x02\n" +
	"*CMsgClientToGCOverworldDevResetAllResponse\x12l\n" +
	"\bresponse\x18\x01 \x01(\x0e2>.protocol.CMsgClientToGCOverworldDevResetAllResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8e\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\rR\x06nodeId\"\xc1\x02\n" +
	"+CMsgClientToGCOverworldDevResetNodeResponse\x12m\n" +
	"\bresponse\x18\x01 \x01(\x0e2?.protocol.CMsgClientToGCOverworldDevResetNodeResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xa2\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x0ek_eInvalidNode\x10\a\"\x97\x01\n" +
	"%CMsgClientToGCOverworldDevGrantTokens\x12!\n" +
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12K\n" +
	"\x0etoken_quantity\x18\x02 \x01(\v2$.protocol.CMsgOverworldTokenQuantityR\rtokenQuantity\"\xb1\x02\n" +
	"-CMsgClientToGCOverworldDevGrantTokensResponse\x12o\n" +
	"\bresponse\x18\x01 \x01(\x0e2A.protocol.CMsgClientToGCOverworldDevGrantTokensResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8e\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\"\xb7\x02\n" +
	"0CMsgClientToGCOverworldDevClearInventoryResponse\x12r\n" +
	"\bresponse\x18\x01 \x01(\x0e2D.protocol.CMsgClientToGCOverworldDevClearInventoryResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8e\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\bfeedback\x18\x03 \x01(\tR\bfeedback\"\xa5\x02\n" +
	"'CMsgClientToGCOverworldFeedbackResponse\x12i\n" +
	"\bresponse\x18\x01 \x01(\x0e2;.protocol.CMsgClientToGCOverworldFeedbackResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8e\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\blanguage\x18\x03 \x01(\rR\blanguage\"\xae\x03\n" +
	".CMsgClientToGCOverworldGetDynamicImageResponse\x12\x19\n" +
	"\bimage_id\x18\x01 \x01(\rR\aimageId\x12V\n" +
	"\x06images\x18\x02 \x03(\v2>.protocol.CMsgClientToGCOverworldGetDynamicImageResponse.ImageR\x06images\x1a\xc8\x01\n" +
	"\x05Image\x12\x14\n" +
	"\x05width\x18\x01 \x01(\rR\x05width\x12\x16\n" +
	"\x06height\x18\x02 \x01(\rR\x06height\x12p\n" +
	"\x06format\x18\x03 \x01(\x0e2L.protocol.CMsgClientToGCOverworldGetDynamicImageResponse.EDynamicImageFormat:\n" +
	"k_eUnknownR\x06format\x12\x1f\n" +
	...
	"\ak_eData\x10\x02\"\xad\x02\n" +
	"%CMsgClientToGCOverworldMinigameAction\x12!\n" +
	"\foverworld_id\x18\x01 \x01(\rR\voverworldId\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\rR\x06nodeId\x12^\n" +
	"\x06action\x18\x03 \x01(\x0e2\".protocol.EOverworldMinigameAction:\"k_eOverworldMinigameAction_InvalidR\x06action\x12\x1c\n" +
	"\tselection\x18\x04 \x01(\rR\tselection\x12!\n" +
	"\foption_value\x18\x05 \x01(\rR\voptionValue\x12'\n" +
	"\x0fcurrency_amount\x18\x06 \x01(\rR\x0ecurrencyAmount\"\xab\x03\n" +
	"-CMsgClientToGCOverworldMinigameActionResponse\x12o\n" +
	"\bresponse\x18\x01 \x01(\x0e2A.protocol.CMsgClientToGCOverworldMinigameActionResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x88\x02\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
