...
type CMsgClientToGCGetInFlightItemChargesResponse struct {
	state           protoimpl.MessageState                                  `protogen:"open.v1"`
	Result          *CMsgClientToGCGetInFlightItemChargesResponse_EResponse `protobuf:"varint,1,opt,name=result,enum=protocol.CMsgClientToGCGetInFlightItemChargesResponse_EResponse,def=0" json:"result,omitempty"`
...
type CMsgClientToGCPurchaseChargeCostItemsResponse struct {
	state         protoimpl.MessageState                                   `protogen:"open.v1"`
	Result        *CMsgClientToGCPurchaseChargeCostItemsResponse_EResponse `protobuf:"varint,1,opt,name=result,enum=protocol.CMsgClientToGCPurchaseChargeCostItemsResponse_EResponse,def=0" json:"result,omitempty"`
	ItemIds       []uint64                                                 `protobuf:"varint,2,rep,name=item_ids,json=itemIds" json:"item_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_econ_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x15econ_gcmessages.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17econ_shared_enums.proto\x1a\x16gcsdk_gcmessages.proto\x1a\x15base_gcmessages.proto\"b\n" +
	...
	"\x0ecrate_item_def\x18\x01 \x01(\rR\fcrateItemDef\"\xde\x01\n" +
	"\x1dCMsgRequestCrateItemsResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\rR\bresponse\x12\x1b\n" +
	"\titem_defs\x18\x02 \x03(\rR\bitemDefs\x12$\n" +
	"\x0epeek_item_defs\x18\x03 \x03(\rR\fpeekItemDefs\x124\n" +
	"\n" +
	"peek_items\x18\x04 \x03(\v2\x15.protocol.CSOEconItemR\tpeekItems\"(\n" +
	"\aEResult\x12\x0f\n" +
	...
	"\x12additional_seconds\x18\x03 \x01(\rR\x11additionalSeconds\"\x99\a\n" +
	...
	"\n" +
	"audit_data\x18\x04 \x01(\x04R\tauditData\x1a\xca\x05\n" +
	"\x04Item\x12\x19\n" +
	...
	"\x0finventory_token\x18\a \x01(\rR\x0einventoryToken\x12\x1c\n" +
	"\aquality\x18\b \x01(\x05:\x02-1R\aquality\x1a\x8d\x01\n" +
	...
	"\tdef_index\x18\x01 \x01(\rR\bdefIndex\"\x81\x02\n" +
	"\x11CMsgGCAddGiftItem\x12*\n" +
	"\x11gifter_account_id\x18\x01 \x01(\rR\x0fgifterAccountId\x12.\n" +
	"\x13receiver_account_id\x18\x02 \x01(\rR\x11receiverAccountId\x128\n" +
	"\fwrapped_item\x18\x03 \x01(\v2\x15.protocol.CSOEconItemR\vwrappedItem\x12!\n" +
	...
	"\x16eResponse_MissingEvent\x10\x05\"\xf1\x05\n" +
	...
	"\x05items\x18\t \x03(\v2*.protocol.CMsgProcessTransactionOrder.ItemR\x05items\x1a\x86\x03\n" +
	"\x04Item\x12$\n" +
	...
	"\rsender_source\x18\x05 \x01(\tR\fsenderSource\"\x91\x02\n" +
	...
	"\bitem_def\x18\x01 \x01(\rR\aitemDef\"\xc1\x02\n" +
	",CMsgClientToGCGetInFlightItemChargesResponse\x12j\n" +
	"\x06result\x18\x01 \x01(\x0e2@.protocol.CMsgClientToGCGetInFlightItemChargesResponse.EResponse:\x10k_eInternalErrorR\x06result\x12*\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\x12\x15\n" +
	"\x11k_eInvalidItemDef\x10\x05\"\xab\x02\n" +
	"%CMsgClientToGCPurchaseChargeCostItems\x12J\n" +
	"\x05items\x18\x01 \x03(\v24.protocol.CMsgClientToGCPurchaseChargeCostItems.ItemR\x05items\x12\x1a\n" +
	...
	"priceIndex\"\x8c\x03\n" +
	"-CMsgClientToGCPurchaseChargeCostItemsResponse\x12k\n" +
	"\x06result\x18\x01 \x01(\x0e2A.protocol.CMsgClientToGCPurchaseChargeCostItemsResponse.EResponse:\x10k_eInternalErrorR\x06result\x12\x19\n" +
	...
	"\"\xe4\x01\n" +
	"$CMsgGCToClientInFlightChargesUpdated\x12f\n" +
	"\x11in_flight_charges\x18\x02 \x03(\v2:.protocol.CMsgGCToClientInFlightChargesUpdated.ItemChargesR\x0finFlightCharges\x1aT\n" +
	...
	"\x06result\x18\x01 \x01(\rR\x06result\"\x85\x01\n" +
	...
	"\tbroadcast\x18\x03 \x01(\bR\tbroadcast\"\xd1\x01\n" +
	"\"CMsgClientToGCRecycleMultipleItems\x12G\n" +
	"\x05items\x18\x01 \x03(\v21.protocol.CMsgClientToGCRecycleMultipleItems.ItemR\x05items\x1ab\n" +
	"\x04Item\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12\x17\n" +
	"\aslot_id\x18\x02 \x01(\rR\x06slotId\x12(\n" +
	"\x10recipe_def_index\x18\x03 \x01(\rR\x0erecipeDefIndex\"~\n" +
	"*CMsgClientToGCRecycleMultipleItemsResponse\x12P\n" +
	"\tresponses\x18\x01 \x03(\v22.protocol.CMsgClientToGCCreateStaticRecipeResponseR\tresponses*\xe1(\n" +
	"\n" +
	"EGCItemMsg\x12\x11\n" +
