...
type CMsgClientToGCSurvivorsGameTelemetryDataResponse struct {
	state         protoimpl.MessageState                                      `protogen:"open.v1"`
	Response      *CMsgClientToGCSurvivorsGameTelemetryDataResponse_EResponse `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCSurvivorsGameTelemetryDataResponse_EResponse,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_dota_gcmessages_common_survivors_proto_rawDesc = "" +
	"\n" +
	"&dota_gcmessages_common_survivors.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17dota_shared_enums.proto\x1a\x1cdota_gcmessages_common.proto\x1a\x16gcsdk_gcmessages.proto\"\xe9\x01\n" +
	"\x15CMsgSurvivorsUserData\x12_\n" +
	"\x10attribute_levels\x18\x01 \x03(\v24.protocol.CMsgSurvivorsUserData.AttributeLevelsEntryR\x0fattributeLevels\x12/\n" +
	...
	"goldEarned\x12Q\n" +
	"\bpowerups\x18\x05 \x03(\v25.protocol.CMsgClientToGCSurvivorsPowerUpTelemetryDataR\bpowerups\x12\x1e\n" +
	"\n" +
	"difficulty\x18\x06 \x01(\rR\n" +
	"difficulty\x123\n" +
	"\x15metaprogression_level\x18\a \x01(\rR\x14metaprogressionLevel\"\xb2\x02\n" +
	"0CMsgClientToGCSurvivorsGameTelemetryDataResponse\x12r\n" +
	"\bresponse\x18\x01 \x01(\x0e2D.protocol.CMsgClientToGCSurvivorsGameTelemetryDataResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x89\x01\n" +
	"\tEResponse\x12\x14\n" +
...
var file_dota_gcmessages_common_survivors_proto_goTypes = []any{
	(CMsgClientToGCSurvivorsGameTelemetryDataResponse_EResponse)(0), // 0: protocol.CMsgClientToGCSurvivorsGameTelemetryDataResponse.EResponse
	(*CMsgSurvivorsUserData)(nil),                                   // 1: protocol.CMsgSurvivorsUserData
	(*CMsgClientToGCSurvivorsPowerUpTelemetryData)(nil),             // 2: protocol.CMsgClientToGCSurvivorsPowerUpTelemetryData
	(*CMsgClientToGCSurvivorsGameTelemetryData)(nil),                // 3: protocol.CMsgClientToGCSurvivorsGameTelemetryData
	(*CMsgClientToGCSurvivorsGameTelemetryDataResponse)(nil),        // 4: protocol.CMsgClientToGCSurvivorsGameTelemetryDataResponse
	(*CMsgSurvivorsUserData_AttributeLevelsEntry)(nil),              // 5: protocol.CMsgSurvivorsUserData.AttributeLevelsEntry
}
var file_dota_gcmessages_common_survivors_proto_depIdxs = []int32{
	5, // 0: protocol.CMsgSurvivorsUserData.attribute_levels:type_name -> protocol.CMsgSurvivorsUserData.AttributeLevelsEntry
	2, // 1: protocol.CMsgClientToGCSurvivorsGameTelemetryData.powerups:type_name -> protocol.CMsgClientToGCSurvivorsPowerUpTelemetryData
	0, // 2: protocol.CMsgClientToGCSurvivorsGameTelemetryDataResponse.response:type_name -> protocol.CMsgClientToGCSurvivorsGameTelemetryDataResponse.EResponse
