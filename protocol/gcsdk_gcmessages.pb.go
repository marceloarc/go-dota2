...
const file_gcsdk_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x16gcsdk_gcmessages.proto\x12\bprotocol\x1a\x15valveextensions.proto\x1a\x13steammessages.proto\x1a,steammessages_steamlearn.steamworkssdk.proto\"\x8b\x01\n" +
	...
	"\ris_compressed\x18\x04 \x01(\bR\fisCompressed\"\xc3\x03\n" +
	"\x18CMsgSteamLearnServerInfo\x12I\n" +
	"\raccess_tokens\x18\x04 \x01(\v2$.protocol.CMsgSteamLearnAccessTokensR\faccessTokens\x12S\n" +
	"\rproject_infos\x18\x05 \x03(\v2..protocol.CMsgSteamLearnServerInfo.ProjectInfoR\fprojectInfos\x1a\x86\x02\n" +
	...
	"\rplatform_name\x18\x17 \x01(\tR\fplatformName\"\xe0\a\n" +
	...
	"\blocation\x18\x05 \x01(\v2$.protocol.CMsgClientWelcome.LocationR\blocation\x125\n" +
...
var file_gcsdk_gcmessages_proto_goTypes = []any{
	...
	(*CMsgSteamLearnServerInfo_ProjectInfo)(nil),                                     // 60: protocol.CMsgSteamLearnServerInfo.ProjectInfo
	(*CMsgSDOAssert_Request)(nil),                                                    // 61: protocol.CMsgSDOAssert.Request
	(*CMsgSOMultipleObjects_SingleObject)(nil),                                       // 62: protocol.CMsgSOMultipleObjects.SingleObject
	(*CMsgSOCacheSubscribed_SubscribedType)(nil),                                     // 63: protocol.CMsgSOCacheSubscribed.SubscribedType
	(*CGCToGCMsgMasterAck_Process)(nil),                                              // 64: protocol.CGCToGCMsgMasterAck.Process
	(*CGCToGCMsgMasterStartupComplete_GCInfo)(nil),                                   // 65: protocol.CGCToGCMsgMasterStartupComplete.GCInfo
	(*CMsgGCUpdateSubGCSessionInfo_CMsgUpdate)(nil),                                  // 66: protocol.CMsgGCUpdateSubGCSessionInfo.CMsgUpdate
	(*CMsgClientWelcome_Location)(nil),                                               // 67: protocol.CMsgClientWelcome.Location
	(*CMsgGCToGCSOCacheSubscribe_CMsgHaveVersions)(nil),                              // 68: protocol.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersions
	(*CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription)(nil),         // 69: protocol.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescription
	(*CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlock)(nil), // 70: protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock
	(*CWorkshop_SetItemPaymentRules_Request_WorkshopItemPaymentRule)(nil),            // 71: protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRule
	(*CWorkshop_SetItemPaymentRules_Request_WorkshopDirectPaymentRule)(nil),          // 72: protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRule
	(*CWorkshop_SetItemPaymentRules_Request_PartnerItemPaymentRule)(nil),             // 73: protocol.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRule
	(*CMsgSerializedSOCache_TypeCache)(nil),                                          // 74: protocol.CMsgSerializedSOCache.TypeCache
	(*CMsgSerializedSOCache_Cache)(nil),                                              // 75: protocol.CMsgSerializedSOCache.Cache
	(*CMsgSerializedSOCache_Cache_Version)(nil),                                      // 76: protocol.CMsgSerializedSOCache.Cache.Version
	(*CMsgSteamLearnAccessTokens)(nil),                                               // 77: protocol.CMsgSteamLearnAccessTokens
	(*CGCSystemMsg_GetAccountDetails_Response)(nil),                                  // 78: protocol.CGCSystemMsg_GetAccountDetails_Response
}
var file_gcsdk_gcmessages_proto_depIdxs = []int32{
	77, // 0: protocol.CMsgSteamLearnServerInfo.access_tokens:type_name -> protocol.CMsgSteamLearnAccessTokens
	60, // 1: protocol.CMsgSteamLearnServerInfo.project_infos:type_name -> protocol.CMsgSteamLearnServerInfo.ProjectInfo
	61, // 2: protocol.CMsgSDOAssert.requests:type_name -> protocol.CMsgSDOAssert.Request
	8,  // 3: protocol.CMsgSOSingleObject.owner_soid:type_name -> protocol.CMsgSOIDOwner
	62, // 4: protocol.CMsgSOMultipleObjects.objects_modified:type_name -> protocol.CMsgSOMultipleObjects.SingleObject
	62, // 5: protocol.CMsgSOMultipleObjects.objects_added:type_name -> protocol.CMsgSOMultipleObjects.SingleObject
	62, // 6: protocol.CMsgSOMultipleObjects.objects_removed:type_name -> protocol.CMsgSOMultipleObjects.SingleObject
	8,  // 7: protocol.CMsgSOMultipleObjects.owner_soid:type_name -> protocol.CMsgSOIDOwner
	63, // 8: protocol.CMsgSOCacheSubscribed.objects:type_name -> protocol.CMsgSOCacheSubscribed.SubscribedType
	8,  // 9: protocol.CMsgSOCacheSubscribed.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 10: protocol.CMsgSOCacheSubscribedUpToDate.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 11: protocol.CMsgSOCacheUnsubscribed.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 12: protocol.CMsgSOCacheSubscriptionCheck.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 13: protocol.CMsgSOCacheSubscriptionRefresh.owner_soid:type_name -> protocol.CMsgSOIDOwner
	64, // 14: protocol.CGCToGCMsgMasterAck.directory:type_name -> protocol.CGCToGCMsgMasterAck.Process
	65, // 15: protocol.CGCToGCMsgMasterStartupComplete.gc_info:type_name -> protocol.CGCToGCMsgMasterStartupComplete.GCInfo
	66, // 16: protocol.CMsgGCUpdateSubGCSessionInfo.updates:type_name -> protocol.CMsgGCUpdateSubGCSessionInfo.CMsgUpdate
	8,  // 17: protocol.CMsgSOCacheHaveVersion.soid:type_name -> protocol.CMsgSOIDOwner
	29, // 18: protocol.CMsgClientHello.socache_have_versions:type_name -> protocol.CMsgSOCacheHaveVersion
	1,  // 19: protocol.CMsgClientHello.client_launcher:type_name -> protocol.PartnerAccountType
	0,  // 20: protocol.CMsgClientHello.engine:type_name -> protocol.ESourceEngine
	11, // 21: protocol.CMsgClientWelcome.outofdate_subscribed_caches:type_name -> protocol.CMsgSOCacheSubscribed
	14, // 22: protocol.CMsgClientWelcome.uptodate_subscribed_caches:type_name -> protocol.CMsgSOCacheSubscriptionCheck
	67, // 23: protocol.CMsgClientWelcome.location:type_name -> protocol.CMsgClientWelcome.Location
	3,  // 24: protocol.CMsgClientWelcome.additional_welcome_msgs:type_name -> protocol.CExtraMsgBlock
	4,  // 25: protocol.CMsgClientWelcome.steam_learn_server_info:type_name -> protocol.CMsgSteamLearnServerInfo
	2,  // 26: protocol.CMsgConnectionStatus.status:type_name -> protocol.GCConnectionStatus
	68, // 27: protocol.CMsgGCToGCSOCacheSubscribe.have_versions:type_name -> protocol.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersions
	78, // 28: protocol.CMsgGCToGCForwardAccountDetails.account_details:type_name -> protocol.CGCSystemMsg_GetAccountDetails_Response
	36, // 29: protocol.CMsgGCToGCLoadSessionSOCache.forward_account_details:type_name -> protocol.CMsgGCToGCForwardAccountDetails
	70, // 30: protocol.CWorkshop_PopulateItemDescriptions_Request.languages:type_name -> protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock
	71, // 31: protocol.CWorkshop_SetItemPaymentRules_Request.associated_workshop_files:type_name -> protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRule
	73, // 32: protocol.CWorkshop_SetItemPaymentRules_Request.partner_accounts:type_name -> protocol.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRule
	72, // 33: protocol.CWorkshop_SetItemPaymentRules_Request.associated_workshop_file_for_direct_payments:type_name -> protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRule
	46, // 34: protocol.CCommunity_GetClanAnnouncements_Response.announcements:type_name -> protocol.CCommunity_ClanAnnouncementInfo
	75, // 35: protocol.CMsgSerializedSOCache.caches:type_name -> protocol.CMsgSerializedSOCache.Cache
	55, // 36: protocol.CMsgGCToGCMasterSubscribeToCacheAsync.subscribe_msg:type_name -> protocol.CMsgGCToGCMasterSubscribeToCache
	69, // 37: protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock.descriptions:type_name -> protocol.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescription
	76, // 38: protocol.CMsgSerializedSOCache.Cache.versions:type_name -> protocol.CMsgSerializedSOCache.Cache.Version
	74, // 39: protocol.CMsgSerializedSOCache.Cache.type_caches:type_name -> protocol.CMsgSerializedSOCache.TypeCache
