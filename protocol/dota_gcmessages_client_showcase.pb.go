...
type CMsgShowcaseItem_Hero struct {
	...
	AnimationPlaybackSpeed *uint32                          `protobuf:"varint,8,opt,name=animation_playback_speed,json=animationPlaybackSpeed,def=100" json:"animation_playback_speed,omitempty"`
...
type CMsgShowcase struct {
	...
	ModerationState *CMsgShowcase_EModerationState `protobuf:"varint,4,opt,name=moderation_state,json=moderationState,enum=protocol.CMsgShowcase_EModerationState,def=0" json:"moderation_state,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CMsgClientToGCShowcaseModerationGetQueueResponse struct {
	state         protoimpl.MessageState                                      `protogen:"open.v1"`
	Response      *CMsgClientToGCShowcaseModerationGetQueueResponse_EResponse `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCShowcaseModerationGetQueueResponse_EResponse,def=0" json:"response,omitempty"`
...
type CMsgClientToGCShowcaseModerationApplyModerationResponse struct {
	state         protoimpl.MessageState                                             `protogen:"open.v1"`
	Response      *CMsgClientToGCShowcaseModerationApplyModerationResponse_EResponse `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCShowcaseModerationApplyModerationResponse_EResponse,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_dota_gcmessages_client_showcase_proto_rawDesc = "" +
	...
	"\x14equipment_slot_index\x18\x04 \x01(\x05:\x02-1R\x12equipmentSlotIndex\"(\n" +
	"\x10CMsgHeroPlusInfo\x12\x14\n" +
	"\x05flags\x18\x01 \x01(\rR\x05flags\"\x9d\x01\n" +
	...
	"\x04Data\x122\n" +
	"\tecon_item\x18\x01 \x01(\v2\x15.protocol.CSOEconItemR\beconItem\"\x95\x05\n" +
	"\x15CMsgShowcaseItem_Hero\x128\n" +
	"\x04data\x18\x01 \x01(\v2$.protocol.CMsgShowcaseItem_Hero.DataR\x04data\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\x05R\x06heroId\x12M\n" +
	...
	"\x05flags\x18\x05 \x01(\rR\x05flags\x127\n" +
	"\tplus_info\x18\x06 \x01(\v2\x1a.protocol.CMsgHeroPlusInfoR\bplusInfo\x12%\n" +
	"\x0eanimation_name\x18\a \x01(\tR\ranimationName\x12=\n" +
	"\x18animation_playback_speed\x18\b \x01(\r:\x03100R\x16animationPlaybackSpeed\x12)\n" +
	"\x10animation_offset\x18\t \x01(\rR\x0fanimationOffset\x12\x17\n" +
	"\x04zoom\x18\n" +
	" \x01(\r:\x03100R\x04zoom\x12\x1d\n" +
	"\n" +
	"slot_index\x18\v \x01(\rR\tslotIndex\x12\x1f\n" +
	"\vmodel_index\x18\f \x01(\rR\n" +
	"modelIndex\x1a\x84\x01\n" +
	"\x04Data\x124\n" +
	"\n" +
	...
	"\ahero_id\x18\x02 \x01(\x05R\x06heroId\x12K\n" +
	"\recon_item_ref\x18\x03 \x01(\v2'.protocol.CMsgShowcaseEconItemReferenceR\veconItemRef\x1a:\n" +
	"\x04Data\x122\n" +
	"\tecon_item\x18\x01 \x01(\v2\x15.protocol.CSOEconItemR\beconItem\"\xb3\x04\n" +
	...
	"\x04Data\x12<\n" +
	"\x0eloading_screen\x18\x01 \x01(\v2\x15.protocol.CSOEconItemR\rloadingScreen\"\xcb\n" +
	"\n" +
	...
	"\x04stat\x18\x0f \x01(\v2\x1f.protocol.CMsgShowcaseItem_StatH\x00R\x04stat\x12=\n" +
	"\x06roshan\x18\x10 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\x06roshan\x12;\n" +
	"\x05creep\x18\x11 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\x05creep\x12;\n" +
	"\x05tower\x18\x12 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\x05tower\x12=\n" +
	"\x06effigy\x18\x13 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\x06effigy\x12E\n" +
	"\n" +
	"decoration\x18\x14 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\n" +
	"decoration\x12B\n" +
	"\n" +
	...
	" \x01(\rR\x11attachmentAnchorY\"\xa5\x02\n" +
	...
	"\x05flags\x18\x05 \x01(\rR\x05flags\"\xcf\x02\n" +
	"\fCMsgShowcase\x12A\n" +
	...
	"background\x12i\n" +
	"\x10moderation_state\x18\x04 \x01(\x0e2'.protocol.CMsgShowcase.EModerationState:\x15k_eModerationState_OkR\x0fmoderationState\"U\n" +
	"\x10EModerationState\x12\x19\n" +
	"\x15k_eModerationState_Ok\x10\x00\x12&\n" +
	"\"k_eModerationState_PendingApproval\x10\x01\"\x99\x01\n" +
	...
	"\x14k_eAlreadyExonerated\x10\x06\"\xc1\x01\n" +
	...
	"\fresult_count\x18\x02 \x01(\rR\vresultCount\"\xe3\x02\n" +
	"0CMsgClientToGCShowcaseModerationGetQueueResponse\x12r\n" +
	"\bresponse\x18\x01 \x01(\x0e2D.protocol.CMsgClientToGCShowcaseModerationGetQueueResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12B\n" +
	"\tshowcases\x18\x02 \x03(\v2$.protocol.CMsgShowcaseModerationInfoR\tshowcases\"w\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\x12\x13\n" +
	"\x0fk_eNoPermission\x10\x05\"\xf0\x01\n" +
	"/CMsgClientToGCShowcaseModerationApplyModeration\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\x12-\n" +
	"\x12showcase_timestamp\x18\x03 \x01(\rR\x11showcaseTimestamp\x12\x18\n" +
	"\aapprove\x18\x04 \x01(\bR\aapprove\"\xbb\x02\n" +
	"7CMsgClientToGCShowcaseModerationApplyModerationResponse\x12y\n" +
	"\bresponse\x18\x01 \x01(\x0e2K.protocol.CMsgClientToGCShowcaseModerationApplyModerationResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x84\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
...
var file_dota_gcmessages_client_showcase_proto_goTypes = []any{
	(EShowcaseHeroPlusFlag)(0),                                             // 0: protocol.EShowcaseHeroPlusFlag
	(EShowcaseType)(0),                                                     // 1: protocol.EShowcaseType
	(EShowcaseItemState)(0),                                                // 2: protocol.EShowcaseItemState
	(EShowcaseAuditAction)(0),                                              // 3: protocol.EShowcaseAuditAction
	(EShowcaseItemFlag)(0),                                                 // 4: protocol.EShowcaseItemFlag
	(EShowcaseItemFlag_Hero)(0),                                            // 5: protocol.EShowcaseItemFlag_Hero
	(CMsgShowcaseItem_PlayerMatch_EPlayerOutcome)(0),                       // 6: protocol.CMsgShowcaseItem_PlayerMatch.EPlayerOutcome
	(CMsgShowcase_EModerationState)(0),                                     // 7: protocol.CMsgShowcase.EModerationState
	(CMsgClientToGCShowcaseGetUserDataResponse_EResponse)(0),               // 8: protocol.CMsgClientToGCShowcaseGetUserDataResponse.EResponse
	(CMsgClientToGCShowcaseSetUserDataResponse_EResponse)(0),               // 9: protocol.CMsgClientToGCShowcaseSetUserDataResponse.EResponse
	(CMsgClientToGCShowcaseSubmitReportResponse_EResponse)(0),              // 10: protocol.CMsgClientToGCShowcaseSubmitReportResponse.EResponse
	(CMsgClientToGCShowcaseAdminGetReportsRollupListResponse_EResponse)(0), // 11: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.EResponse
	(CMsgClientToGCShowcaseAdminGetReportsRollupResponse_EResponse)(0),     // 12: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.EResponse
	(CMsgClientToGCShowcaseAdminGetUserDetailsResponse_EResponse)(0),       // 13: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.EResponse
	(CMsgClientToGCShowcaseAdminResetResponse_EResponse)(0),                // 14: protocol.CMsgClientToGCShowcaseAdminResetResponse.EResponse
	(CMsgClientToGCShowcaseAdminLockAccountResponse_EResponse)(0),          // 15: protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.EResponse
	(CMsgClientToGCShowcaseAdminConvictResponse_EResponse)(0),              // 16: protocol.CMsgClientToGCShowcaseAdminConvictResponse.EResponse
	(CMsgClientToGCShowcaseAdminExonerateResponse_EResponse)(0),            // 17: protocol.CMsgClientToGCShowcaseAdminExonerateResponse.EResponse
	(CMsgClientToGCShowcaseModerationGetQueueResponse_EResponse)(0),        // 18: protocol.CMsgClientToGCShowcaseModerationGetQueueResponse.EResponse
	(CMsgClientToGCShowcaseModerationApplyModerationResponse_EResponse)(0), // 19: protocol.CMsgClientToGCShowcaseModerationApplyModerationResponse.EResponse
	(*CMsgShowcaseEconItemReference)(nil),                                  // 20: protocol.CMsgShowcaseEconItemReference
	(*CMsgHeroPlusInfo)(nil),                                               // 21: protocol.CMsgHeroPlusInfo
	(*CMsgShowcaseItem_Trophy)(nil),                                        // 22: protocol.CMsgShowcaseItem_Trophy
	(*CMsgShowcaseItem_EconItem)(nil),                                      // 23: protocol.CMsgShowcaseItem_EconItem
	(*CMsgShowcaseItem_Hero)(nil),                                          // 24: protocol.CMsgShowcaseItem_Hero
	(*CMsgShowcaseItem_HeroIcon)(nil),                                      // 25: protocol.CMsgShowcaseItem_HeroIcon
	(*CMsgShowcaseItem_PlayerMatch)(nil),                                   // 26: protocol.CMsgShowcaseItem_PlayerMatch
	(*CMsgShowcaseItem_ChatWheel)(nil),                                     // 27: protocol.CMsgShowcaseItem_ChatWheel
	(*CMsgShowcaseItem_Emoticon)(nil),                                      // 28: protocol.CMsgShowcaseItem_Emoticon
	(*CMsgShowcaseItem_SpiderGraph)(nil),                                   // 29: protocol.CMsgShowcaseItem_SpiderGraph
	(*CMsgShowcaseItem_UserFeed)(nil),                                      // 30: protocol.CMsgShowcaseItem_UserFeed
	(*CMsgShowcaseItem_Stat)(nil),                                          // 31: protocol.CMsgShowcaseItem_Stat
	(*CMsgShowcaseBackground)(nil),                                         // 32: protocol.CMsgShowcaseBackground
	(*CMsgShowcaseItemData)(nil),                                           // 33: protocol.CMsgShowcaseItemData
	(*CMsgShowcaseItemPosition)(nil),                                       // 34: protocol.CMsgShowcaseItemPosition
	(*CMsgShowcaseItem)(nil),                                               // 35: protocol.CMsgShowcaseItem
	(*CMsgShowcase)(nil),                                                   // 36: protocol.CMsgShowcase
	(*CMsgClientToGCShowcaseGetUserData)(nil),                              // 37: protocol.CMsgClientToGCShowcaseGetUserData
	(*CMsgClientToGCShowcaseGetUserDataResponse)(nil),                      // 38: protocol.CMsgClientToGCShowcaseGetUserDataResponse
	(*CMsgClientToGCShowcaseSetUserData)(nil),                              // 39: protocol.CMsgClientToGCShowcaseSetUserData
	(*CMsgClientToGCShowcaseSetUserDataResponse)(nil),                      // 40: protocol.CMsgClientToGCShowcaseSetUserDataResponse
	(*CMsgClientToGCShowcaseSubmitReport)(nil),                             // 41: protocol.CMsgClientToGCShowcaseSubmitReport
	(*CMsgClientToGCShowcaseSubmitReportResponse)(nil),                     // 42: protocol.CMsgClientToGCShowcaseSubmitReportResponse
	(*CMsgShowcaseReportsRollupInfo)(nil),                                  // 43: protocol.CMsgShowcaseReportsRollupInfo
	(*CMsgShowcaseReportsRollupList)(nil),                                  // 44: protocol.CMsgShowcaseReportsRollupList
	(*CMsgShowcaseReportsRollupEntry)(nil),                                 // 45: protocol.CMsgShowcaseReportsRollupEntry
	(*CMsgShowcaseReportsRollup)(nil),                                      // 46: protocol.CMsgShowcaseReportsRollup
	(*CMsgClientToGCShowcaseAdminGetReportsRollupList)(nil),                // 47: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupList
	(*CMsgClientToGCShowcaseAdminGetReportsRollupListResponse)(nil),        // 48: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse
	(*CMsgClientToGCShowcaseAdminGetReportsRollup)(nil),                    // 49: protocol.CMsgClientToGCShowcaseAdminGetReportsRollup
	(*CMsgClientToGCShowcaseAdminGetReportsRollupResponse)(nil),            // 50: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse
	(*CMsgShowcaseAuditEntry)(nil),                                         // 51: protocol.CMsgShowcaseAuditEntry
	(*CMsgShowcaseReport)(nil),                                             // 52: protocol.CMsgShowcaseReport
	(*CMsgShowcaseAdminUserDetails)(nil),                                   // 53: protocol.CMsgShowcaseAdminUserDetails
	(*CMsgClientToGCShowcaseAdminGetUserDetails)(nil),                      // 54: protocol.CMsgClientToGCShowcaseAdminGetUserDetails
	(*CMsgClientToGCShowcaseAdminGetUserDetailsResponse)(nil),              // 55: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse
	(*CMsgClientToGCShowcaseAdminReset)(nil),                               // 56: protocol.CMsgClientToGCShowcaseAdminReset
	(*CMsgClientToGCShowcaseAdminResetResponse)(nil),                       // 57: protocol.CMsgClientToGCShowcaseAdminResetResponse
	(*CMsgClientToGCShowcaseAdminLockAccount)(nil),                         // 58: protocol.CMsgClientToGCShowcaseAdminLockAccount
	(*CMsgClientToGCShowcaseAdminLockAccountResponse)(nil),                 // 59: protocol.CMsgClientToGCShowcaseAdminLockAccountResponse
	(*CMsgClientToGCShowcaseAdminConvict)(nil),                             // 60: protocol.CMsgClientToGCShowcaseAdminConvict
	(*CMsgClientToGCShowcaseAdminConvictResponse)(nil),                     // 61: protocol.CMsgClientToGCShowcaseAdminConvictResponse
	(*CMsgClientToGCShowcaseAdminExonerate)(nil),                           // 62: protocol.CMsgClientToGCShowcaseAdminExonerate
	(*CMsgClientToGCShowcaseAdminExonerateResponse)(nil),                   // 63: protocol.CMsgClientToGCShowcaseAdminExonerateResponse
	(*CMsgShowcaseModerationInfo)(nil),                                     // 64: protocol.CMsgShowcaseModerationInfo
	(*CMsgClientToGCShowcaseModerationGetQueue)(nil),                       // 65: protocol.CMsgClientToGCShowcaseModerationGetQueue
	(*CMsgClientToGCShowcaseModerationGetQueueResponse)(nil),               // 66: protocol.CMsgClientToGCShowcaseModerationGetQueueResponse
	(*CMsgClientToGCShowcaseModerationApplyModeration)(nil),                // 67: protocol.CMsgClientToGCShowcaseModerationApplyModeration
	(*CMsgClientToGCShowcaseModerationApplyModerationResponse)(nil),        // 68: protocol.CMsgClientToGCShowcaseModerationApplyModerationResponse
	(*CMsgShowcaseItem_Trophy_Data)(nil),                                   // 69: protocol.CMsgShowcaseItem_Trophy.Data
	(*CMsgShowcaseItem_EconItem_Data)(nil),                                 // 70: protocol.CMsgShowcaseItem_EconItem.Data
	(*CMsgShowcaseItem_Hero_Data)(nil),                                     // 71: protocol.CMsgShowcaseItem_Hero.Data
	(*CMsgShowcaseItem_HeroIcon_Data)(nil),                                 // 72: protocol.CMsgShowcaseItem_HeroIcon.Data
	(*CMsgShowcaseItem_PlayerMatch_Data)(nil),                              // 73: protocol.CMsgShowcaseItem_PlayerMatch.Data
	(*CMsgShowcaseItem_ChatWheel_Data)(nil),                                // 74: protocol.CMsgShowcaseItem_ChatWheel.Data
	(*CMsgShowcaseItem_Emoticon_Data)(nil),                                 // 75: protocol.CMsgShowcaseItem_Emoticon.Data
	(*CMsgShowcaseItem_SpiderGraph_Data)(nil),                              // 76: protocol.CMsgShowcaseItem_SpiderGraph.Data
	(*CMsgShowcaseItem_UserFeed_Data)(nil),                                 // 77: protocol.CMsgShowcaseItem_UserFeed.Data
	(*CMsgShowcaseItem_Stat_Data)(nil),                                     // 78: protocol.CMsgShowcaseItem_Stat.Data
	(*CMsgShowcaseBackground_Data)(nil),                                    // 79: protocol.CMsgShowcaseBackground.Data
	(CMsgDOTAProfileCard_EStatID)(0),                                       // 80: protocol.CMsgDOTAProfileCard.EStatID
	(*CSOEconItem)(nil),                                                    // 81: protocol.CSOEconItem
	(DOTA_GameMode)(0),                                                     // 82: protocol.DOTA_GameMode
}
var file_dota_gcmessages_client_showcase_proto_depIdxs = []int32{
	69, // 0: protocol.CMsgShowcaseItem_Trophy.data:type_name -> protocol.CMsgShowcaseItem_Trophy.Data
	70, // 1: protocol.CMsgShowcaseItem_EconItem.data:type_name -> protocol.CMsgShowcaseItem_EconItem.Data
	20, // 2: protocol.CMsgShowcaseItem_EconItem.ref:type_name -> protocol.CMsgShowcaseEconItemReference
	71, // 3: protocol.CMsgShowcaseItem_Hero.data:type_name -> protocol.CMsgShowcaseItem_Hero.Data
	20, // 4: protocol.CMsgShowcaseItem_Hero.econ_item_refs:type_name -> protocol.CMsgShowcaseEconItemReference
	21, // 5: protocol.CMsgShowcaseItem_Hero.plus_info:type_name -> protocol.CMsgHeroPlusInfo
	72, // 6: protocol.CMsgShowcaseItem_HeroIcon.data:type_name -> protocol.CMsgShowcaseItem_HeroIcon.Data
	20, // 7: protocol.CMsgShowcaseItem_HeroIcon.econ_item_ref:type_name -> protocol.CMsgShowcaseEconItemReference
	73, // 8: protocol.CMsgShowcaseItem_PlayerMatch.data:type_name -> protocol.CMsgShowcaseItem_PlayerMatch.Data
	74, // 9: protocol.CMsgShowcaseItem_ChatWheel.data:type_name -> protocol.CMsgShowcaseItem_ChatWheel.Data
	75, // 10: protocol.CMsgShowcaseItem_Emoticon.data:type_name -> protocol.CMsgShowcaseItem_Emoticon.Data
	76, // 11: protocol.CMsgShowcaseItem_SpiderGraph.data:type_name -> protocol.CMsgShowcaseItem_SpiderGraph.Data
	77, // 12: protocol.CMsgShowcaseItem_UserFeed.data:type_name -> protocol.CMsgShowcaseItem_UserFeed.Data
	78, // 13: protocol.CMsgShowcaseItem_Stat.data:type_name -> protocol.CMsgShowcaseItem_Stat.Data
	80, // 14: protocol.CMsgShowcaseItem_Stat.stat_id:type_name -> protocol.CMsgDOTAProfileCard.EStatID
	79, // 15: protocol.CMsgShowcaseBackground.data:type_name -> protocol.CMsgShowcaseBackground.Data
	20, // 16: protocol.CMsgShowcaseBackground.loading_screen_ref:type_name -> protocol.CMsgShowcaseEconItemReference
	22, // 17: protocol.CMsgShowcaseItemData.trophy:type_name -> protocol.CMsgShowcaseItem_Trophy
	23, // 18: protocol.CMsgShowcaseItemData.econ_item_icon:type_name -> protocol.CMsgShowcaseItem_EconItem
	23, // 19: protocol.CMsgShowcaseItemData.sticker:type_name -> protocol.CMsgShowcaseItem_EconItem
	24, // 20: protocol.CMsgShowcaseItemData.hero_model:type_name -> protocol.CMsgShowcaseItem_Hero
	26, // 21: protocol.CMsgShowcaseItemData.player_match:type_name -> protocol.CMsgShowcaseItem_PlayerMatch
	27, // 22: protocol.CMsgShowcaseItemData.chat_wheel:type_name -> protocol.CMsgShowcaseItem_ChatWheel
	27, // 23: protocol.CMsgShowcaseItemData.spray:type_name -> protocol.CMsgShowcaseItem_ChatWheel
	28, // 24: protocol.CMsgShowcaseItemData.emoticon:type_name -> protocol.CMsgShowcaseItem_Emoticon
	23, // 25: protocol.CMsgShowcaseItemData.courier:type_name -> protocol.CMsgShowcaseItem_EconItem
	23, // 26: protocol.CMsgShowcaseItemData.ward:type_name -> protocol.CMsgShowcaseItem_EconItem
	25, // 27: protocol.CMsgShowcaseItemData.hero_icon:type_name -> protocol.CMsgShowcaseItem_HeroIcon
	29, // 28: protocol.CMsgShowcaseItemData.spider_graph:type_name -> protocol.CMsgShowcaseItem_SpiderGraph
	30, // 29: protocol.CMsgShowcaseItemData.user_feed:type_name -> protocol.CMsgShowcaseItem_UserFeed
	31, // 30: protocol.CMsgShowcaseItemData.stat:type_name -> protocol.CMsgShowcaseItem_Stat
	23, // 31: protocol.CMsgShowcaseItemData.roshan:type_name -> protocol.CMsgShowcaseItem_EconItem
	23, // 32: protocol.CMsgShowcaseItemData.creep:type_name -> protocol.CMsgShowcaseItem_EconItem
	23, // 33: protocol.CMsgShowcaseItemData.tower:type_name -> protocol.CMsgShowcaseItem_EconItem
	23, // 34: protocol.CMsgShowcaseItemData.effigy:type_name -> protocol.CMsgShowcaseItem_EconItem
	23, // 35: protocol.CMsgShowcaseItemData.decoration:type_name -> protocol.CMsgShowcaseItem_EconItem
	32, // 36: protocol.CMsgShowcaseItemData.background:type_name -> protocol.CMsgShowcaseBackground
	34, // 37: protocol.CMsgShowcaseItem.item_position:type_name -> protocol.CMsgShowcaseItemPosition
	33, // 38: protocol.CMsgShowcaseItem.item_data:type_name -> protocol.CMsgShowcaseItemData
	2,  // 39: protocol.CMsgShowcaseItem.state:type_name -> protocol.EShowcaseItemState
	35, // 40: protocol.CMsgShowcase.showcase_items:type_name -> protocol.CMsgShowcaseItem
	35, // 41: protocol.CMsgShowcase.background:type_name -> protocol.CMsgShowcaseItem
	7,  // 42: protocol.CMsgShowcase.moderation_state:type_name -> protocol.CMsgShowcase.EModerationState
	1,  // 43: protocol.CMsgClientToGCShowcaseGetUserData.showcase_type:type_name -> protocol.EShowcaseType
	8,  // 44: protocol.CMsgClientToGCShowcaseGetUserDataResponse.response:type_name -> protocol.CMsgClientToGCShowcaseGetUserDataResponse.EResponse
	36, // 45: protocol.CMsgClientToGCShowcaseGetUserDataResponse.showcase:type_name -> protocol.CMsgShowcase
	1,  // 46: protocol.CMsgClientToGCShowcaseSetUserData.showcase_type:type_name -> protocol.EShowcaseType
	36, // 47: protocol.CMsgClientToGCShowcaseSetUserData.showcase:type_name -> protocol.CMsgShowcase
	9,  // 48: protocol.CMsgClientToGCShowcaseSetUserDataResponse.response:type_name -> protocol.CMsgClientToGCShowcaseSetUserDataResponse.EResponse
	36, // 49: protocol.CMsgClientToGCShowcaseSetUserDataResponse.validated_showcase:type_name -> protocol.CMsgShowcase
	1,  // 50: protocol.CMsgClientToGCShowcaseSubmitReport.showcase_type:type_name -> protocol.EShowcaseType
	10, // 51: protocol.CMsgClientToGCShowcaseSubmitReportResponse.response:type_name -> protocol.CMsgClientToGCShowcaseSubmitReportResponse.EResponse
	43, // 52: protocol.CMsgShowcaseReportsRollupList.rollups:type_name -> protocol.CMsgShowcaseReportsRollupInfo
	1,  // 53: protocol.CMsgShowcaseReportsRollupEntry.showcase_type:type_name -> protocol.EShowcaseType
	43, // 54: protocol.CMsgShowcaseReportsRollup.rollup_info:type_name -> protocol.CMsgShowcaseReportsRollupInfo
	45, // 55: protocol.CMsgShowcaseReportsRollup.rollup_entries:type_name -> protocol.CMsgShowcaseReportsRollupEntry
	11, // 56: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.EResponse
	44, // 57: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.rollup_list:type_name -> protocol.CMsgShowcaseReportsRollupList
	12, // 58: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.EResponse
	46, // 59: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.rollup:type_name -> protocol.CMsgShowcaseReportsRollup
	1,  // 60: protocol.CMsgShowcaseAuditEntry.showcase_type:type_name -> protocol.EShowcaseType
	3,  // 61: protocol.CMsgShowcaseAuditEntry.audit_action:type_name -> protocol.EShowcaseAuditAction
	1,  // 62: protocol.CMsgShowcaseReport.showcase_type:type_name -> protocol.EShowcaseType
	51, // 63: protocol.CMsgShowcaseAdminUserDetails.audit_entries:type_name -> protocol.CMsgShowcaseAuditEntry
	52, // 64: protocol.CMsgShowcaseAdminUserDetails.reports:type_name -> protocol.CMsgShowcaseReport
	13, // 65: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.EResponse
	53, // 66: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.user_details:type_name -> protocol.CMsgShowcaseAdminUserDetails
	1,  // 67: protocol.CMsgClientToGCShowcaseAdminReset.showcase_type:type_name -> protocol.EShowcaseType
	14, // 68: protocol.CMsgClientToGCShowcaseAdminResetResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminResetResponse.EResponse
	15, // 69: protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.EResponse
	1,  // 70: protocol.CMsgClientToGCShowcaseAdminConvict.showcase_type:type_name -> protocol.EShowcaseType
	16, // 71: protocol.CMsgClientToGCShowcaseAdminConvictResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminConvictResponse.EResponse
	1,  // 72: protocol.CMsgClientToGCShowcaseAdminExonerate.showcase_type:type_name -> protocol.EShowcaseType
	17, // 73: protocol.CMsgClientToGCShowcaseAdminExonerateResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminExonerateResponse.EResponse
	1,  // 74: protocol.CMsgShowcaseModerationInfo.showcase_type:type_name -> protocol.EShowcaseType
	18, // 75: protocol.CMsgClientToGCShowcaseModerationGetQueueResponse.response:type_name -> protocol.CMsgClientToGCShowcaseModerationGetQueueResponse.EResponse
	64, // 76: protocol.CMsgClientToGCShowcaseModerationGetQueueResponse.showcases:type_name -> protocol.CMsgShowcaseModerationInfo
	1,  // 77: protocol.CMsgClientToGCShowcaseModerationApplyModeration.showcase_type:type_name -> protocol.EShowcaseType
	19, // 78: protocol.CMsgClientToGCShowcaseModerationApplyModerationResponse.response:type_name -> protocol.CMsgClientToGCShowcaseModerationApplyModerationResponse.EResponse
	81, // 79: protocol.CMsgShowcaseItem_EconItem.Data.econ_item:type_name -> protocol.CSOEconItem
	81, // 80: protocol.CMsgShowcaseItem_Hero.Data.econ_items:type_name -> protocol.CSOEconItem
	81, // 81: protocol.CMsgShowcaseItem_HeroIcon.Data.econ_item:type_name -> protocol.CSOEconItem
	82, // 82: protocol.CMsgShowcaseItem_PlayerMatch.Data.game_mode:type_name -> protocol.DOTA_GameMode
	6,  // 83: protocol.CMsgShowcaseItem_PlayerMatch.Data.outcome:type_name -> protocol.CMsgShowcaseItem_PlayerMatch.EPlayerOutcome
	81, // 84: protocol.CMsgShowcaseBackground.Data.loading_screen:type_name -> protocol.CSOEconItem
