...
type CNETMsg_SignonState struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	SignonState       *SignonStateT          `protobuf:"varint,1,opt,name=signon_state,json=signonState,enum=protocol.SignonStateT,def=0" json:"signon_state,omitempty"`
...
const file_networkbasetypes_proto_rawDesc = "" +
	"\n" +
	"\x16networkbasetypes.proto\x12\bprotocol\x1a google/protobuf/descriptor.proto\x1a\x18network_connection.proto\"D\n" +
	"\n" +
	"CMsgVector\x12\f\n" +
	...
	"\x01y\x18\x02 \x01(\x02R\x01y\x12\f\n" +
	"\x01z\x18\x03 \x01(\x02R\x01z\x12\f\n" +
	"\x01w\x18\x04 \x01(\x02R\x01w\"\x93\x01\n" +
	"\rCMsgTransform\x120\n" +
	"\bposition\x18\x01 \x01(\v2\x14.protocol.CMsgVectorR\bposition\x12\x14\n" +
	"\x05scale\x18\x02 \x01(\x02R\x05scale\x12:\n" +
	"\vorientation\x18\x03 \x01(\v2\x18.protocol.CMsgQuaternionR\vorientation\"B\n" +
	"\bCMsgRGBA\x12\f\n" +
	...
	"\n" +
	"CEntityMsg\x12-\n" +
	"\rtarget_entity\x18\x01 \x01(\r:\b16777215R\ftargetEntity\"o\n" +
	"\n" +
	"CMsg_CVars\x12/\n" +
	"\x05cvars\x18\x01 \x03(\v2\x19.protocol.CMsg_CVars.CVarR\x05cvars\x1a0\n" +
	"\x04CVar\x12\x12\n" +
	...
	"\x06addons\x18\x06 \x01(\tR\x06addons\"\xea\x02\n" +
	"\x11CSVCMsg_GameEvent\x12\x1d\n" +
	"\n" +
	"event_name\x18\x01 \x01(\tR\teventName\x12\x18\n" +
	"\aeventid\x18\x02 \x01(\x05R\aeventid\x125\n" +
	"\x04keys\x18\x03 \x03(\v2!.protocol.CSVCMsg_GameEvent.key_tR\x04keys\x1a\xe4\x01\n" +
	"\x05key_t\x12\x12\n" +
	...
	"\n" +
	"val_uint64\x18\b \x01(\x04R\tvalUint64\"\xac\x01\n" +
	"\x16CSVCMsgList_GameEvents\x12@\n" +
	"\x06events\x18\x01 \x03(\v2(.protocol.CSVCMsgList_GameEvents.event_tR\x06events\x1aP\n" +
	"\aevent_t\x12\x12\n" +
	"\x04tick\x18\x01 \x01(\x05R\x04tick\x121\n" +
	"\x05event\x18\x02 \x01(\v2\x1b.protocol.CSVCMsg_GameEventR\x05event\"\x99\a\n" +
	...
	"\x10world_offset_pos\x18\x06 \x01(\v2\x14.protocol.CMsgVectorR\x0eworldOffsetPos\x12B\n" +
	"\x12world_offset_angle\x18\a \x01(\v2\x14.protocol.CMsgQAngleR\x10worldOffsetAngle\x12.\n" +
	...
	"\flandmarkname\x18\x12 \x01(\tR\flandmarkname\"\x88\x02\n" +
	"\x14CNETMsg_DebugOverlay\x12\x14\n" +
	"\x05etype\x18\x01 \x01(\x05R\x05etype\x12.\n" +
	"\avectors\x18\x02 \x03(\v2\x14.protocol.CMsgVectorR\avectors\x12*\n" +
	"\x06colors\x18\x03 \x03(\v2\x12.protocol.CMsgRGBAR\x06colors\x12\x1e\n" +
	"\n" +
...
var file_networkbasetypes_proto_goTypes = []any{
	(SignonStateT)(0),                          // 0: protocol.SignonState_t
	(NET_Messages)(0),                          // 1: protocol.NET_Messages
	(SpawnGroupFlagsT)(0),                      // 2: protocol.SpawnGroupFlags_t
	(*CMsgVector)(nil),                         // 3: protocol.CMsgVector
	(*CMsgVector2D)(nil),                       // 4: protocol.CMsgVector2D
	(*CMsgQAngle)(nil),                         // 5: protocol.CMsgQAngle
	(*CMsgQuaternion)(nil),                     // 6: protocol.CMsgQuaternion
	(*CMsgTransform)(nil),                      // 7: protocol.CMsgTransform
	(*CMsgRGBA)(nil),                           // 8: protocol.CMsgRGBA
	(*CMsgPlayerInfo)(nil),                     // 9: protocol.CMsgPlayerInfo
	(*CEntityMsg)(nil),                         // 10: protocol.CEntityMsg
	(*CMsg_CVars)(nil),                         // 11: protocol.CMsg_CVars
	(*CNETMsg_NOP)(nil),                        // 12: protocol.CNETMsg_NOP
	(*CNETMsg_SplitScreenUser)(nil),            // 13: protocol.CNETMsg_SplitScreenUser
	(*CNETMsg_Tick)(nil),                       // 14: protocol.CNETMsg_Tick
	(*CNETMsg_StringCmd)(nil),                  // 15: protocol.CNETMsg_StringCmd
	(*CNETMsg_SetConVar)(nil),                  // 16: protocol.CNETMsg_SetConVar
	(*CNETMsg_SignonState)(nil),                // 17: protocol.CNETMsg_SignonState
	(*CSVCMsg_GameEvent)(nil),                  // 18: protocol.CSVCMsg_GameEvent
	(*CSVCMsgList_GameEvents)(nil),             // 19: protocol.CSVCMsgList_GameEvents
	(*CNETMsg_SpawnGroup_Load)(nil),            // 20: protocol.CNETMsg_SpawnGroup_Load
	(*CNETMsg_SpawnGroup_ManifestUpdate)(nil),  // 21: protocol.CNETMsg_SpawnGroup_ManifestUpdate
	(*CNETMsg_SpawnGroup_SetCreationTick)(nil), // 22: protocol.CNETMsg_SpawnGroup_SetCreationTick
	(*CNETMsg_SpawnGroup_Unload)(nil),          // 23: protocol.CNETMsg_SpawnGroup_Unload
	(*CNETMsg_SpawnGroup_LoadCompleted)(nil),   // 24: protocol.CNETMsg_SpawnGroup_LoadCompleted
	(*CSVCMsg_GameSessionConfiguration)(nil),   // 25: protocol.CSVCMsg_GameSessionConfiguration
	(*CNETMsg_DebugOverlay)(nil),               // 26: protocol.CNETMsg_DebugOverlay
	(*CMsg_CVars_CVar)(nil),                    // 27: protocol.CMsg_CVars.CVar
	(*CSVCMsg_GameEventKeyT)(nil),              // 28: protocol.CSVCMsg_GameEvent.key_t
	(*CSVCMsgList_GameEventsEventT)(nil),       // 29: protocol.CSVCMsgList_GameEvents.event_t
	(*descriptorpb.MessageOptions)(nil),        // 30: google.protobuf.MessageOptions
}
var file_networkbasetypes_proto_depIdxs = []int32{
	3,  // 0: protocol.CMsgTransform.position:type_name -> protocol.CMsgVector
	6,  // 1: protocol.CMsgTransform.orientation:type_name -> protocol.CMsgQuaternion
	27, // 2: protocol.CMsg_CVars.cvars:type_name -> protocol.CMsg_CVars.CVar
	11, // 3: protocol.CNETMsg_SetConVar.convars:type_name -> protocol.CMsg_CVars
	0,  // 4: protocol.CNETMsg_SignonState.signon_state:type_name -> protocol.SignonState_t
	28, // 5: protocol.CSVCMsg_GameEvent.keys:type_name -> protocol.CSVCMsg_GameEvent.key_t
	29, // 6: protocol.CSVCMsgList_GameEvents.events:type_name -> protocol.CSVCMsgList_GameEvents.event_t
	3,  // 7: protocol.CNETMsg_SpawnGroup_Load.world_offset_pos:type_name -> protocol.CMsgVector
	5,  // 8: protocol.CNETMsg_SpawnGroup_Load.world_offset_angle:type_name -> protocol.CMsgQAngle
	3,  // 9: protocol.CNETMsg_DebugOverlay.vectors:type_name -> protocol.CMsgVector
	8,  // 10: protocol.CNETMsg_DebugOverlay.colors:type_name -> protocol.CMsgRGBA
	18, // 11: protocol.CSVCMsgList_GameEvents.event_t.event:type_name -> protocol.CSVCMsg_GameEvent
	30, // 12: protocol.maximum_size_bytes:extendee -> google.protobuf.MessageOptions
