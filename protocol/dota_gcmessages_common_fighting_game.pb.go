...
const file_dota_gcmessages_common_fighting_game_proto_rawDesc = "" +
	"\n" +
	"*dota_gcmessages_common_fighting_game.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17dota_shared_enums.proto\x1a\x1cdota_gcmessages_common.proto\x1a\x16gcsdk_gcmessages.proto\"W\n" +
	")CMsgClientToGCFightingGameChallengeFriend\x12*\n" +
	"\x11friend_account_id\x18\x01 \x01(\rR\x0ffriendAccountId\"\xcd\x02\n" +
	"1CMsgClientToGCFightingGameChallengeFriendResponse\x12s\n" +
	"\bresponse\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCFightingGameChallengeFriendResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xa2\x01\n" +
	"\tEResponse\x12\x14\n" +
	...
	"\x06accept\x18\x02 \x01(\bR\x06accept\"\xa5\x02\n" +
	"1CMsgClientToGCFightingGameAnswerChallengeResponse\x12s\n" +
	"\bresponse\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCFightingGameAnswerChallengeResponse.EResponse:\x10k_eInternalErrorR\bresponse\"{\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x15challenger_account_id\x18\x01 \x01(\rR\x13challengerAccountId\x120\n" +
	"\x14responder_account_id\x18\x02 \x01(\rR\x12responderAccountId"
