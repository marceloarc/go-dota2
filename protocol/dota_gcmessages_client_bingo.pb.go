...
const file_dota_gcmessages_client_bingo_proto_rawDesc = "" +
	...
	"tokenCount\"D\n" +
	"\rCMsgBingoCard\x123\n" +
	"\asquares\x18\x01 \x03(\v2\x19.protocol.CMsgBingoSquareR\asquares\"\xdd\x02\n" +
	"\x11CMsgBingoUserData\x12L\n" +
	"\vbingo_cards\x18\x01 \x03(\v2+.protocol.CMsgBingoUserData.BingoCardsEntryR\n" +
	"bingoCards\x12O\n" +
	"\fbingo_tokens\x18\x02 \x03(\v2,.protocol.CMsgBingoUserData.BingoTokensEntryR\vbingoTokens\x1aR\n" +
	"\x0fBingoCardsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.protocol.CMsgBingoCardR\x05value\x1aU\n" +
	"\x10BingoTokensEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.protocol.CMsgBingoTokensR\x05value\"=\n" +
	"\x1eCMsgClientToGCBingoGetUserData\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\"\xb0\x02\n" +
	...
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x128\n" +
	"\tuser_data\x18\x02 \x01(\v2\x1b.protocol.CMsgBingoUserDataR\buserData\"z\n" +
	...
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x12!\n" +
	"\fleague_phase\x18\x02 \x01(\rR\vleaguePhase\"\xb9\x02\n" +
	"&CMsgClientToGCBingoShuffleCardResponse\x12h\n" +
	"\bresponse\x18\x01 \x01(\x0e2:.protocol.CMsgClientToGCBingoShuffleCardResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xa4\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x15k_eInsufficientTokens\x10\b\"\x98\x02\n" +
	"\x1fCMsgClientToGCBingoModifySquare\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x12!\n" +
	"\fleague_phase\x18\x02 \x01(\rR\vleaguePhase\x12!\n" +
	"\fsquare_index\x18\x03 \x01(\rR\vsquareIndex\x12^\n" +
	"\x06action\x18\x04 \x01(\x0e27.protocol.CMsgClientToGCBingoModifySquare.EModifyAction:\rk_eRerollStatR\x06action\"2\n" +
	"\rEModifyAction\x12\x11\n" +
	"\rk_eRerollStat\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eUpgrade\x10\x01\"\xf8\x02\n" +
	"'CMsgClientToGCBingoModifySquareResponse\x12i\n" +
	"\bresponse\x18\x01 \x01(\x0e2;.protocol.CMsgClientToGCBingoModifySquareResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xe1\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"tokenCount\"\xa0\x02\n" +
	"'CMsgClientToGCBingoDevAddTokensResponse\x12i\n" +
	"\bresponse\x18\x01 \x01(\x0e2;.protocol.CMsgClientToGCBingoDevAddTokensResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x89\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\"\xaa\x02\n" +
	",CMsgClientToGCBingoDevClearInventoryResponse\x12n\n" +
	"\bresponse\x18\x01 \x01(\x0e2@.protocol.CMsgClientToGCBingoDevClearInventoryResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x89\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
